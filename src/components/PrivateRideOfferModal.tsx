...
const offerFormSchema = z.object({
  ...
  seats_offered: z.number().min(1, "Must offer at least 1 seat").max(7, "Maximum 7 seats"),
...
interface PrivateRideOfferModalProps {
  open: boolean;
  onClose: () => void;
  recipientId: string;
    ...
    try {
      ...
      if (existingOffers && existingOffers.length > 0) {
        toast({
          ...
          description: `You already have a pending offer with ${recipientName} for this date and time.`,
          variant: "destructive",
        });
        setSubmitting(false);
        return;
      ...
      const { data: offerData, error: insertError } = await supabase
        ...
        .insert({
          ...
          seats_needed: null,
          seats_offered: values.seats_offered,
      ...
      const { error: notifError } = await supabase
        ...
        .insert({
          user_id: recipientId,
          type: 'ride_connected',
          message: `${userProfile.first_name || userProfile.username} is giving you a ride on ${format(values.ride_date, 'MMM d, yyyy')} at ${values.pickup_time}! Contact them to coordinate.`,
          is_read: false,
        });
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <Card className="bg-muted/50">
                <CardContent className="p-4 space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    You'll pick up {recipientName} along your route
                  </p>
                </CardContent>
              </Card>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-col">
                      <FormLabel>When can you offer a ride? *</FormLabel>
                      <Popover>
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription>
                        Can you offer both to and from school?
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>How many seats can you offer? *</FormLabel>
                    <FormDescription className="text-xs">
                      Total seats available in your vehicle
                    </FormDescription>
                    <Select
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder={`Tell ${recipientName} any details... e.g., car seat available, pickup flexibility, regular schedule, etc.`}
...
export default PrivateRideOfferModal;
