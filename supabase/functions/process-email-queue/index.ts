...
Deno.serve(async (req) => {
  ...
  // the gateway layer. Scheduled jobs may use either a JWT service-role token
  // or Lovable Cloud's newer secret key format, so allow an exact service-key
  // match before falling back to JWT claim inspection.
